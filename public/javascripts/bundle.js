...
},{"../helpers/settle":17,"./../helpers/btoa":10,"./../helpers/buildURL":11,"./../helpers/cookies":13,"./../helpers/isURLSameOrigin":15,"./../helpers/parseHeaders":16,"./../helpers/transformData":19,"./../utils":20,"_process":42}],5:[function(require,module,exports){
'use strict';
...
},{"./core/InterceptorManager":6,"./core/dispatchRequest":7,"./defaults":8,"./helpers/bind":9,"./helpers/combineURLs":12,"./helpers/isAbsoluteURL":14,"./helpers/spread":18,"./helpers/transformData":19,"./utils":20}],6:[function(require,module,exports){
'use strict';
...
},{"../adapters/http":4,"../adapters/xhr":4,"_process":42}],8:[function(require,module,exports){
'use strict';
...
},{"./Concepts":23,"./Inputs":25,"./Models":27,"./constants":28,"./helpers":29,"_process":42,"axios":3,"promise":33}],22:[function(require,module,exports){
"use strict";
...
},{"./Concept":22,"./constants":28,"./helpers":29,"./utils":31,"axios":3}],24:[function(require,module,exports){
'use strict';
...
},{"./Concepts":23,"./constants":28,"axios":3}],25:[function(require,module,exports){
'use strict';
...
},{"./Input":24,"./constants":28,"./helpers":29,"./utils":31,"axios":3}],26:[function(require,module,exports){
'use strict';
...
},{"./constants":28,"./helpers":29,"./utils":31,"axios":3}],27:[function(require,module,exports){
'use strict';
...
},{"./Concepts":23,"./Model":26,"./constants":28,"./helpers":29,"./utils":31,"axios":3,"promise":33}],28:[function(require,module,exports){
'use strict';
...
},{"./../package.json":32,"./App":21}],31:[function(require,module,exports){
'use strict';
...
},{"./../package.json":32,"./constants":28,"./helpers":29,"promise":33}],32:[function(require,module,exports){
module.exports={
  "_args": [
    [
      {
      ...
      "/Users/meghnapai/Documents/hackny"
    ]
  ],
  ...
  "_shrinkwrap": null,
  "_spec": "clarifai",
  "_where": "/Users/meghnapai/Documents/hackny",
  "author": {
    "name": "Clarifai Inc."
  },
  "bugs": {
...
},{"asap/raw":2}],35:[function(require,module,exports){
'use strict';
...
},{"./core.js":34,"asap":1}],40:[function(require,module,exports){
'use strict';
    ...
    app.models.predict("ASL", {base64:uri}).then(
        function(response){
            for (var i = 0; i < response.outputs.length; ++i) {
                ...
                Materialize.toast(finalString, 4000) // 4000 is the duration of the toast
            }
...
},{"clarifai":30}],42:[function(require,module,exports){
